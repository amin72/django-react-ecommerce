...
export const ORDER_ITEM_DELETE_URL = id => `${END_POINT}/order-items/${id}/delete/`
export const ORDER_ITEM_QUANTITY_UPDATE_URL = `${END_POINT}/order-item/update-quantity/`
...
export const PAYMENT_LIST_URL = `${END_POINT}/payments/`
